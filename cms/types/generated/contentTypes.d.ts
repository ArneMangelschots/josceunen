...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Tekst en foto voor de Over-pagina';
    displayName: 'Over de kunstenaar';
    pluralName: 'abouts';
    singularName: 'about';
  };
  options: {
...
export interface ApiArtworkArtwork extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Voeg hier kunstwerken toe voor de website';
    displayName: 'Kunstwerk';
    pluralName: 'artworks';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date: Schema.Attribute.Date & Schema.Attribute.Private;
...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blogberichten voor de website';
    displayName: 'Blogbericht';
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Uitgelichte kunstwerken op de landingspagina';
...
export interface ApiTechniqueTechnique extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Tags voor technieken (olieverf, acryl, \u2026)';
...
export interface ApiThemeTheme extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Tags voor thema's (landschap, portret, \u2026)";
    displayName: 'Thema';
    pluralName: 'themes';
    singularName: 'theme';
  };
